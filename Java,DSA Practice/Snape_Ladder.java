...
class Snape_Ladder
{
    ...
    public Snape_Ladder(double x, double y) 
	{
        this.x = x;
        this.y = y;
    }
    ...
    public static void main(String[] args) 
	{
        ...
        List<Snape_Ladder> ladders = new ArrayList<>();
        ...
        Snape_Ladder ladder = new Snape_Ladder(x, y);
        ladders.add(ladder);
		ladders.add(ladder);

        // You can access the values in the list like this
        for (Snape_Ladder Snape_Ladder : ladders) 
		{
            System.out.println("Hypotenuse: " + Snape_Ladder.Professor1());
			System.out.println("Hypotenuse: "+  Snape_Ladder.Professor2());
        }
    }
}
